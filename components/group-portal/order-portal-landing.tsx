...
import { ArrowRight, Building2, Layers, LogOut, ShoppingCart } from "lucide-react"
...
/**
 * Landing page for GROUP_ORDER_PORTAL.
 *
 * It confirms who the user is and exactly which branches an administrator gave
 * them, then hands off to the bulk ordering workspace. GROUP_USER no longer
 * lands here — that role opens straight into its approval workspace — so this
 * view carries only the requester's side of the group portal.
 */
export function OrderPortalLanding() {
