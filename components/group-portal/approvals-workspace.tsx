...
import { ClipboardCheck, Layers, Package } from "lucide-react"
...
/**
 * The Group User's approval workspace, and the role's landing view.
 *
 * It renders inside the shared portal shell, so navigation and signing out are
 * the sidebar's and topbar's job rather than this component's.
 */
