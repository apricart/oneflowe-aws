...
describe("session policy proxy enforcement", () => {
  ...
  it.each([
    ...
    // The multi-branch approval workspace is exclusive to the approver role,
    // and closed to the requester that raises the orders being decided.
    ["GROUP_USER", "/group-portal/approvals", null],
    ["GROUP_ORDER_PORTAL", "/group-portal/approvals", "/group-portal"],
    ["SUPER_ADMIN", "/group-portal/approvals", "/dashboard"],
    ["HEAD_OFFICE", "/group-portal/approvals", "/dashboard"],
    ["BRANCH_ADMIN", "/group-portal/approvals", "/dashboard"],
    ["ORDER_PORTAL", "/group-portal/approvals", "/shop"],
